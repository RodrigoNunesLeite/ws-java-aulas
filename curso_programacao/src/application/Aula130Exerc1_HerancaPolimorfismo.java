...
public class Aula130Exerc1_HerancaPolimorfismo {
	...
	public static void main(String[] args) {
		 ...
		 * arrecadado. 
		 * Os dados de pessoa física são: nome, renda anual e gastos com
		...
		for(int i = 1; i <= numberPayers; i ++) {
			...
			if(type == 'i') {
				...
				listPayer.add(new Company(name, anualIncome, numberEmp));
			}
		}
