...
public class Aula191Exerc1_Interface {
	...
	public static void main(String[] args) throws ParseException {
		 ...
		 * Os serviços de pagamento online tipicamente cobram um juro mensal, bem como uma
		...
		for(Installment eachInstallment: contract.getLstInstallments()) {
			System.out.println(eachInstallment);
		}
